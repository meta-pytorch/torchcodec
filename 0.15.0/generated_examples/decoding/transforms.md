...
```
decoder transforms: times_med = 1935.59ms +- 40.12
torchvision transform: times_med = 4075.54ms +- 110.53
```
...
```
decoder transforms: times_med = 10765.18ms +- 10.20
torchvision transform: times_med = 12557.40ms +- 6.29
```
...
**Total running time of the script:** (2 minutes 26.500 seconds)
