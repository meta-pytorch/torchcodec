...
```
decoder transforms: times_med = 1964.86ms +- 13.85
torchvision transform: times_med = 4112.32ms +- 120.37
```
...
```
decoder transforms: times_med = 10724.92ms +- 17.45
torchvision transform: times_med = 12507.28ms +- 23.86
```
...
**Total running time of the script:** (2 minutes 26.051 seconds)
