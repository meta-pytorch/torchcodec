...
```
decoder transforms: times_med = 1982.71ms +- 26.44
torchvision transform: times_med = 4031.45ms +- 88.93
```
...
```
decoder transforms: times_med = 10747.55ms +- 20.43
torchvision transform: times_med = 12478.36ms +- 19.78
```
...
**Total running time of the script:** (2 minutes 26.726 seconds)
