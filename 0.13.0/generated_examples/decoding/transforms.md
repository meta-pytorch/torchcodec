...
```
decoder transforms: times_med = 1984.84ms +- 18.81
torchvision transform: times_med = 4222.50ms +- 70.70
```
...
```
decoder transforms: times_med = 10682.73ms +- 9.77
torchvision transform: times_med = 12516.94ms +- 5.41
```
...
**Total running time of the script:** (2 minutes 26.263 seconds)
