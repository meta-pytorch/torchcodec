...
torch.cuda.get_device_properties(0)=_CudaDeviceProperties(name='NVIDIA A10G', major=8, minor=6, total_memory=22587MB, multi_processor_count=80, uuid=17812b2d-e6a3-bb2a-a031-77494e7ac27a, pci_bus_id=0, pci_device_id=30, pci_domain_id=0, L2_cache_size=6MB)
```
...
```
('video.mp4', <http.client.HTTPMessage object at 0x7f2a4de0cf70>)
```
