...
# This module holds the torch (torch.ops / torch.compile) implementation of the
# core ops. The shared libraries are loaded once in ops.py, which dispatches
# here when torch is available; we reuse the pybind handle it loaded.
