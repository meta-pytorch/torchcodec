...
```
decoder transforms: times_med = 1980.67ms +- 24.58
torchvision transform: times_med = 4076.12ms +- 159.34
```
...
```
decoder transforms: times_med = 10715.67ms +- 19.77
torchvision transform: times_med = 12517.59ms +- 10.52
```
...
**Total running time of the script:** (2 minutes 25.859 seconds)
