...
```
torch.__version__='2.12.0.dev20260331+cu126'
torch.cuda.is_available()=True
torch.cuda.get_device_properties(0)=_CudaDeviceProperties(name='NVIDIA A10G', major=8, minor=6, total_memory=22587MB, multi_processor_count=80, uuid=fccdda55-8373-9621-27f4-e8bf01edb427, pci_bus_id=0, pci_device_id=30, pci_domain_id=0, L2_cache_size=6MB)
```
...
```
('video.mp4', <http.client.HTTPMessage object at 0x7f70081dcd60>)
```
