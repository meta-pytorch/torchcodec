...
```
Running ffprobe:
ffprobe -i /tmp/tmpyg8glabg/long_video.mp4 -select_streams 0 -show_frames -show_entries frame=pts,duration,key_frame -of json

Running ffprobe:
ffprobe -i /tmp/tmpyg8glabg/short_video.mp4 -select_streams 0 -show_frames -show_entries frame=pts,duration,key_frame -of json
...
**Total running time of the script:** (0 minutes 23.984 seconds)
