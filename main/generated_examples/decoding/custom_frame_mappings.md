...
```
Running ffprobe:
ffprobe -i /tmp/tmpsimo26jg/long_video.mp4 -select_streams 0 -show_frames -show_entries frame=pts,duration,key_frame -of json

Running ffprobe:
ffprobe -i /tmp/tmpsimo26jg/short_video.mp4 -select_streams 0 -show_frames -show_entries frame=pts,duration,key_frame -of json
...
**Total running time of the script:** (0 minutes 23.550 seconds)
