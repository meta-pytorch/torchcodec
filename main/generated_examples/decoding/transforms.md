...
```
decoder transforms: times_med = 1973.01ms +- 5.42
torchvision transform: times_med = 4168.30ms +- 84.23
```
...
```
decoder transforms: times_med = 10727.87ms +- 13.61
torchvision transform: times_med = 12521.48ms +- 21.56
```
