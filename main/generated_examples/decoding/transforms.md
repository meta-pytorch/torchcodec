...
```
decoder transforms: times_med = 1969.91ms +- 23.46
torchvision transform: times_med = 4106.22ms +- 132.31
```
...
```
decoder transforms: times_med = 10633.39ms +- 10.00
torchvision transform: times_med = 12448.91ms +- 16.62
```
...
**Total running time of the script:** (2 minutes 19.959 seconds)
