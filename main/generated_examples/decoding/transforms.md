...
```
decoder transforms: times_med = 1936.71ms +- 8.52
torchvision transform: times_med = 4030.06ms +- 9.19
```
...
```
decoder transforms: times_med = 10673.94ms +- 22.15
torchvision transform: times_med = 12433.48ms +- 11.81
```
...
**Total running time of the script:** (2 minutes 25.560 seconds)
