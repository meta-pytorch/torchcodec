...
```
decoder transforms: times_med = 1967.14ms +- 16.41
torchvision transform: times_med = 4084.09ms +- 52.25
```
...
```
decoder transforms: times_med = 10762.24ms +- 18.15
torchvision transform: times_med = 12561.77ms +- 11.58
```
