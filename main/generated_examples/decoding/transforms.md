...
```
decoder transforms: times_med = 1982.55ms +- 13.29
torchvision transform: times_med = 4097.09ms +- 96.80
```
...
```
decoder transforms: times_med = 10695.23ms +- 36.74
torchvision transform: times_med = 12501.42ms +- 20.30
```
...
**Total running time of the script:** (2 minutes 28.329 seconds)
