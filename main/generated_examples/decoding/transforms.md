...
```
decoder transforms: times_med = 1990.33ms +- 6.27
torchvision transform: times_med = 4247.46ms +- 102.73
```
...
```
decoder transforms: times_med = 10707.13ms +- 17.30
torchvision transform: times_med = 12520.29ms +- 3.42
```
