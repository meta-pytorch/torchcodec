...
```
decoder transforms: times_med = 1975.89ms +- 17.63
torchvision transform: times_med = 4048.37ms +- 141.89
```
...
```
decoder transforms: times_med = 10753.74ms +- 9.49
torchvision transform: times_med = 12517.90ms +- 2.50
```
...
**Total running time of the script:** (2 minutes 26.377 seconds)
