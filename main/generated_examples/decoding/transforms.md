...
```
decoder transforms: times_med = 1956.66ms +- 17.52
torchvision transform: times_med = 4058.33ms +- 102.62
```
...
```
decoder transforms: times_med = 10745.88ms +- 24.98
torchvision transform: times_med = 12484.88ms +- 17.46
```
...
**Total running time of the script:** (2 minutes 26.756 seconds)
