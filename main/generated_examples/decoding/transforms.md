...
```
decoder transforms: times_med = 1982.10ms +- 12.81
torchvision transform: times_med = 4082.57ms +- 7.25
```
...
```
decoder transforms: times_med = 10734.81ms +- 14.36
torchvision transform: times_med = 12551.45ms +- 22.84
```
