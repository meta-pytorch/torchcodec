...
```
decoder transforms: times_med = 1970.12ms +- 16.88
torchvision transform: times_med = 4077.98ms +- 61.30
```
...
```
decoder transforms: times_med = 10619.05ms +- 30.47
torchvision transform: times_med = 12503.31ms +- 5.49
```
