...
```
decoder transforms: times_med = 1979.36ms +- 18.81
torchvision transform: times_med = 4103.29ms +- 30.04
```
...
```
decoder transforms: times_med = 10711.20ms +- 14.22
torchvision transform: times_med = 12494.31ms +- 10.08
```
...
**Total running time of the script:** (2 minutes 26.153 seconds)
