...
```
decoder transforms: times_med = 1951.84ms +- 8.62
torchvision transform: times_med = 4067.49ms +- 88.96
```
...
```
decoder transforms: times_med = 10690.42ms +- 12.23
torchvision transform: times_med = 12472.23ms +- 10.21
```
