...
```
decoder transforms: times_med = 1947.42ms +- 17.74
torchvision transform: times_med = 4040.16ms +- 19.17
```
...
```
decoder transforms: times_med = 10686.17ms +- 39.60
torchvision transform: times_med = 12461.10ms +- 14.73
```
...
**Total running time of the script:** (2 minutes 26.016 seconds)
