...
```
decoder transforms: times_med = 1995.93ms +- 8.74
torchvision transform: times_med = 4249.87ms +- 105.79
```
...
```
decoder transforms: times_med = 11005.81ms +- 13.16
torchvision transform: times_med = 12785.83ms +- 2.69
```
