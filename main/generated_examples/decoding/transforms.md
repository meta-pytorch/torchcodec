...
```
decoder transforms: times_med = 2013.40ms +- 27.17
torchvision transform: times_med = 4088.89ms +- 21.72
```
...
```
decoder transforms: times_med = 10841.01ms +- 22.04
torchvision transform: times_med = 12661.30ms +- 14.29
```
...
**Total running time of the script:** (2 minutes 27.055 seconds)
