...
```
decoder transforms: times_med = 1961.28ms +- 37.16
torchvision transform: times_med = 4053.19ms +- 6.21
```
...
```
decoder transforms: times_med = 10772.21ms +- 37.15
torchvision transform: times_med = 12560.93ms +- 6.73
```
