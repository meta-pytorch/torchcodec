...
```
decoder transforms: times_med = 1969.63ms +- 25.85
torchvision transform: times_med = 4187.98ms +- 68.54
```
...
```
decoder transforms: times_med = 10724.20ms +- 29.09
torchvision transform: times_med = 12509.07ms +- 6.25
```
