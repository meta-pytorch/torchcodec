...
```
decoder transforms: times_med = 1984.91ms +- 5.84
torchvision transform: times_med = 4066.76ms +- 32.48
```
...
```
decoder transforms: times_med = 11040.64ms +- 2.25
torchvision transform: times_med = 12882.30ms +- 2.24
```
...
**Total running time of the script:** (2 minutes 28.919 seconds)
