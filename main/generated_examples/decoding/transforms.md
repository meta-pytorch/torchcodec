...
```
decoder transforms: times_med = 1970.16ms +- 8.55
torchvision transform: times_med = 4087.24ms +- 89.72
```
...
```
decoder transforms: times_med = 10697.82ms +- 8.88
torchvision transform: times_med = 12472.34ms +- 12.15
```
