...
```
decoder transforms: times_med = 1964.83ms +- 22.74
torchvision transform: times_med = 4134.35ms +- 136.77
```
...
```
decoder transforms: times_med = 10817.34ms +- 22.41
torchvision transform: times_med = 12713.30ms +- 32.03
```
...
**Total running time of the script:** (2 minutes 27.568 seconds)
