...
```
decoder transforms: times_med = 1941.71ms +- 17.23
torchvision transform: times_med = 4040.06ms +- 2.57
```
...
```
decoder transforms: times_med = 10702.13ms +- 6.07
torchvision transform: times_med = 12538.74ms +- 10.83
```
