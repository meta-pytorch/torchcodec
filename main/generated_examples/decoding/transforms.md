...
```
decoder transforms: times_med = 1982.44ms +- 24.48
torchvision transform: times_med = 4127.67ms +- 90.27
```
...
```
decoder transforms: times_med = 10721.02ms +- 92.46
torchvision transform: times_med = 12540.22ms +- 39.92
```
