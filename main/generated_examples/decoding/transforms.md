...
```
decoder transforms: times_med = 1973.65ms +- 18.97
torchvision transform: times_med = 4059.46ms +- 49.16
```
...
```
decoder transforms: times_med = 10770.05ms +- 43.89
torchvision transform: times_med = 12491.84ms +- 18.35
```
...
**Total running time of the script:** (2 minutes 26.720 seconds)
