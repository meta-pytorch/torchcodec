...
```
decoder transforms: times_med = 1968.15ms +- 9.44
torchvision transform: times_med = 4071.44ms +- 12.49
```
...
```
decoder transforms: times_med = 10793.54ms +- 10.04
torchvision transform: times_med = 12599.39ms +- 8.15
```
