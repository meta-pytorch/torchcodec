...
```
decoder transforms: times_med = 1976.93ms +- 21.99
torchvision transform: times_med = 4120.09ms +- 77.27
```
...
```
decoder transforms: times_med = 10706.08ms +- 1.67
torchvision transform: times_med = 12555.80ms +- 27.79
```
