...
```
decoder transforms: times_med = 1965.11ms +- 12.88
torchvision transform: times_med = 4054.97ms +- 2.99
```
...
```
decoder transforms: times_med = 10749.07ms +- 17.19
torchvision transform: times_med = 12506.84ms +- 25.19
```
