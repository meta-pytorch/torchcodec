...
```
decoder transforms: times_med = 1988.36ms +- 7.04
torchvision transform: times_med = 4126.12ms +- 44.01
```
...
```
decoder transforms: times_med = 10807.60ms +- 41.00
torchvision transform: times_med = 12562.93ms +- 26.64
```
...
**Total running time of the script:** (2 minutes 26.809 seconds)
