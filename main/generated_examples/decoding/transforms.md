...
```
decoder transforms: times_med = 1942.39ms +- 7.44
torchvision transform: times_med = 4050.07ms +- 19.99
```
...
```
decoder transforms: times_med = 10743.46ms +- 12.22
torchvision transform: times_med = 12515.85ms +- 10.07
```
