...
```
decoder transforms: times_med = 1947.33ms +- 10.93
torchvision transform: times_med = 4167.74ms +- 102.61
```
...
```
decoder transforms: times_med = 10773.73ms +- 14.52
torchvision transform: times_med = 12574.70ms +- 24.26
```
