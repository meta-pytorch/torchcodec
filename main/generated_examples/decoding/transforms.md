...
```
decoder transforms: times_med = 1953.20ms +- 26.81
torchvision transform: times_med = 4033.54ms +- 5.76
```
...
```
decoder transforms: times_med = 10708.72ms +- 19.52
torchvision transform: times_med = 12496.12ms +- 14.36
```
...
**Total running time of the script:** (2 minutes 26.189 seconds)
