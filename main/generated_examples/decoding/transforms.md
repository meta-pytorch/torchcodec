...
```
decoder transforms: times_med = 2000.11ms +- 25.63
torchvision transform: times_med = 4089.94ms +- 11.59
```
...
```
decoder transforms: times_med = 10907.85ms +- 4.89
torchvision transform: times_med = 12728.21ms +- 17.92
```
