...
```
decoder transforms: times_med = 1977.67ms +- 42.54
torchvision transform: times_med = 4161.29ms +- 124.03
```
...
```
decoder transforms: times_med = 10940.06ms +- 16.65
torchvision transform: times_med = 12647.70ms +- 10.97
```
...
**Total running time of the script:** (2 minutes 27.668 seconds)
