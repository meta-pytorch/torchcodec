...
```
decoder transforms: times_med = 1981.71ms +- 13.43
torchvision transform: times_med = 4066.33ms +- 55.27
```
...
```
decoder transforms: times_med = 10708.53ms +- 7.24
torchvision transform: times_med = 12520.53ms +- 18.63
```
...
**Total running time of the script:** (2 minutes 26.672 seconds)
