...
```
decoder transforms: times_med = 1977.90ms +- 35.27
torchvision transform: times_med = 4069.29ms +- 1.96
```
...
```
decoder transforms: times_med = 10754.72ms +- 30.42
torchvision transform: times_med = 12586.73ms +- 23.33
```
...
**Total running time of the script:** (2 minutes 27.345 seconds)
