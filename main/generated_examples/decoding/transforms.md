...
```
decoder transforms: times_med = 2007.85ms +- 14.04
torchvision transform: times_med = 4103.27ms +- 54.42
```
...
```
decoder transforms: times_med = 10654.69ms +- 12.95
torchvision transform: times_med = 12517.02ms +- 1.57
```
...
**Total running time of the script:** (2 minutes 25.829 seconds)
