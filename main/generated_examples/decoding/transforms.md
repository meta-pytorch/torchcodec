...
```
decoder transforms: times_med = 2035.78ms +- 21.17
torchvision transform: times_med = 4147.79ms +- 57.69
```
...
```
decoder transforms: times_med = 10739.94ms +- 10.97
torchvision transform: times_med = 12574.91ms +- 0.44
```
...
**Total running time of the script:** (2 minutes 26.520 seconds)
