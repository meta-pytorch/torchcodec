...
```
decoder transforms: times_med = 1952.16ms +- 10.77
torchvision transform: times_med = 4054.59ms +- 61.25
```
...
```
decoder transforms: times_med = 10679.03ms +- 9.35
torchvision transform: times_med = 12461.14ms +- 24.87
```
