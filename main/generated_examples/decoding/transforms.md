...
```
decoder transforms: times_med = 1968.76ms +- 4.46
torchvision transform: times_med = 4047.24ms +- 156.07
```
...
```
decoder transforms: times_med = 10711.24ms +- 33.37
torchvision transform: times_med = 12448.46ms +- 6.84
```
...
**Total running time of the script:** (2 minutes 27.930 seconds)
