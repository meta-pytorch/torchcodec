...
```
decoder transforms: times_med = 1949.96ms +- 16.65
torchvision transform: times_med = 4189.59ms +- 72.47
```
...
```
decoder transforms: times_med = 10743.91ms +- 14.04
torchvision transform: times_med = 12687.27ms +- 6.33
```
