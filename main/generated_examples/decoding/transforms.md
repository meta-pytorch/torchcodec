...
```
decoder transforms: times_med = 1985.90ms +- 7.14
torchvision transform: times_med = 4109.65ms +- 75.85
```
...
```
decoder transforms: times_med = 10701.34ms +- 18.07
torchvision transform: times_med = 12567.32ms +- 37.70
```
...
**Total running time of the script:** (2 minutes 28.609 seconds)
