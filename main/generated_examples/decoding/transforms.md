...
```
decoder transforms: times_med = 1951.32ms +- 9.07
torchvision transform: times_med = 4052.57ms +- 80.90
```
...
```
decoder transforms: times_med = 10712.98ms +- 17.85
torchvision transform: times_med = 12461.54ms +- 24.83
```
...
**Total running time of the script:** (2 minutes 27.180 seconds)
