...
```
decoder transforms: times_med = 1978.12ms +- 14.01
torchvision transform: times_med = 4049.70ms +- 14.43
```
...
```
decoder transforms: times_med = 10727.82ms +- 35.32
torchvision transform: times_med = 12511.46ms +- 27.64
```
...
**Total running time of the script:** (2 minutes 26.469 seconds)
