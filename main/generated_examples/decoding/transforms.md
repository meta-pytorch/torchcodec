...
```
decoder transforms: times_med = 1951.13ms +- 18.07
torchvision transform: times_med = 4122.22ms +- 46.67
```
...
```
decoder transforms: times_med = 10769.95ms +- 26.52
torchvision transform: times_med = 12567.51ms +- 7.57
```
...
**Total running time of the script:** (2 minutes 26.390 seconds)
