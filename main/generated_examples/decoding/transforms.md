...
```
decoder transforms: times_med = 1991.40ms +- 19.52
torchvision transform: times_med = 4045.72ms +- 96.55
```
...
```
decoder transforms: times_med = 10711.02ms +- 2.88
torchvision transform: times_med = 12454.41ms +- 24.55
```
...
**Total running time of the script:** (2 minutes 26.025 seconds)
