...
```
decoder transforms: times_med = 1978.39ms +- 4.33
torchvision transform: times_med = 4093.33ms +- 80.63
```
...
```
decoder transforms: times_med = 10722.05ms +- 8.95
torchvision transform: times_med = 12543.81ms +- 6.89
```
...
**Total running time of the script:** (2 minutes 25.774 seconds)
