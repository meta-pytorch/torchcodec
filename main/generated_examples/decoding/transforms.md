...
```
decoder transforms: times_med = 1968.03ms +- 2.15
torchvision transform: times_med = 4196.98ms +- 124.36
```
...
```
decoder transforms: times_med = 10738.70ms +- 3.44
torchvision transform: times_med = 12494.50ms +- 25.23
```
