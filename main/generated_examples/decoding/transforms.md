...
```
decoder transforms: times_med = 1987.03ms +- 22.81
torchvision transform: times_med = 4109.58ms +- 116.51
```
...
```
decoder transforms: times_med = 10901.38ms +- 25.44
torchvision transform: times_med = 12745.53ms +- 13.03
```
...
**Total running time of the script:** (2 minutes 27.880 seconds)
