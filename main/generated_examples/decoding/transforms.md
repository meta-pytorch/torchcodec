...
```
decoder transforms: times_med = 1958.28ms +- 14.58
torchvision transform: times_med = 4031.59ms +- 91.72
```
...
```
decoder transforms: times_med = 10716.54ms +- 30.28
torchvision transform: times_med = 12473.80ms +- 11.15
```
...
**Total running time of the script:** (2 minutes 26.616 seconds)
