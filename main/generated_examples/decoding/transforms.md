...
```
decoder transforms: times_med = 1988.81ms +- 17.88
torchvision transform: times_med = 4063.66ms +- 145.89
```
...
```
decoder transforms: times_med = 10829.53ms +- 48.88
torchvision transform: times_med = 12495.25ms +- 25.78
```
