...
```
decoder transforms: times_med = 1978.51ms +- 24.45
torchvision transform: times_med = 4101.90ms +- 49.30
```
...
```
decoder transforms: times_med = 10691.13ms +- 13.07
torchvision transform: times_med = 12445.42ms +- 21.74
```
...
**Total running time of the script:** (2 minutes 20.204 seconds)
