...
```
decoder transforms: times_med = 1961.87ms +- 10.65
torchvision transform: times_med = 4065.05ms +- 23.62
```
...
```
decoder transforms: times_med = 10767.66ms +- 10.47
torchvision transform: times_med = 12519.21ms +- 14.41
```
