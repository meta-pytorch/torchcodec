...
```
decoder transforms: times_med = 1970.86ms +- 19.52
torchvision transform: times_med = 4289.38ms +- 115.61
```
...
```
decoder transforms: times_med = 10674.45ms +- 10.64
torchvision transform: times_med = 12499.21ms +- 9.79
```
