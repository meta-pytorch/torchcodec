...
```
decoder transforms: times_med = 1972.03ms +- 18.08
torchvision transform: times_med = 4080.91ms +- 111.55
```
...
```
decoder transforms: times_med = 10731.75ms +- 19.84
torchvision transform: times_med = 12564.05ms +- 25.61
```
...
**Total running time of the script:** (2 minutes 26.481 seconds)
