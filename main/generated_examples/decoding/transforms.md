...
```
decoder transforms: times_med = 1942.53ms +- 41.13
torchvision transform: times_med = 4113.72ms +- 90.26
```
...
```
decoder transforms: times_med = 10705.53ms +- 8.23
torchvision transform: times_med = 12539.47ms +- 7.57
```
