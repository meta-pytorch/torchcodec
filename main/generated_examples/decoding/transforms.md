...
```
decoder transforms: times_med = 1993.88ms +- 12.00
torchvision transform: times_med = 4078.19ms +- 146.96
```
...
```
decoder transforms: times_med = 10748.17ms +- 2.44
torchvision transform: times_med = 12549.70ms +- 28.15
```
...
**Total running time of the script:** (2 minutes 28.382 seconds)
