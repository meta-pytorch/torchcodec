...
```
decoder transforms: times_med = 1979.99ms +- 11.18
torchvision transform: times_med = 4110.67ms +- 105.76
```
...
```
decoder transforms: times_med = 10661.95ms +- 17.75
torchvision transform: times_med = 12465.48ms +- 33.10
```
...
**Total running time of the script:** (2 minutes 28.435 seconds)
