...
```
decoder transforms: times_med = 1982.76ms +- 48.78
torchvision transform: times_med = 4107.40ms +- 60.21
```
...
```
decoder transforms: times_med = 10698.75ms +- 5.03
torchvision transform: times_med = 12479.68ms +- 8.79
```
...
**Total running time of the script:** (2 minutes 20.594 seconds)
