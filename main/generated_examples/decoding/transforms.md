...
```
decoder transforms: times_med = 1990.77ms +- 44.23
torchvision transform: times_med = 4066.64ms +- 56.28
```
...
```
decoder transforms: times_med = 10736.96ms +- 15.54
torchvision transform: times_med = 12577.23ms +- 21.11
```
