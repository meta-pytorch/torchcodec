...
```
median = 3.70s ± 0.06
Speedup compared to sequential: 3.01x with 16 FFmpeg threads.
```
...
```
median = 1.43s ± 0.06
Speedup compared to sequential: 7.80x with 16 threads.
```
...
**Total running time of the script:** (1 minutes 27.318 seconds)
