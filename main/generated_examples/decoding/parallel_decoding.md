...
```
median = 5.66s ± 0.05
Speedup compared to sequential: 1.93x with 16 FFmpeg threads.
```
...
```
median = 4.35s ± 0.07
Speedup compared to sequential: 2.52x with 16 processes.
```
...
```
median = 1.43s ± 0.06
Speedup compared to sequential: 7.66x with 16 threads.
```
...
**Total running time of the script:** (1 minutes 34.221 seconds)
