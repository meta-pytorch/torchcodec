...
```
median = 5.70s ± 0.05
Speedup compared to sequential: 1.94x with 16 FFmpeg threads.
```
...
```
median = 1.43s ± 0.06
Speedup compared to sequential: 7.71x with 16 threads.
```
...
**Total running time of the script:** (1 minutes 34.938 seconds)
