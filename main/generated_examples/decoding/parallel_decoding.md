...
```
median = 5.70s ± 0.06
Speedup compared to sequential: 1.97x with 16 FFmpeg threads.
```
...
```
median = 4.36s ± 0.07
Speedup compared to sequential: 2.58x with 16 processes.
```
...
```
median = 1.43s ± 0.05
Speedup compared to sequential: 7.83x with 16 threads.
```
...
**Total running time of the script:** (1 minutes 35.761 seconds)
