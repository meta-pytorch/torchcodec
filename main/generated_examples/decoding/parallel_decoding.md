...
```
median = 3.71s ± 0.06
Speedup compared to sequential: 3.00x with 16 FFmpeg threads.
```
...
```
median = 1.44s ± 0.06
Speedup compared to sequential: 7.74x with 16 threads.
```
...
**Total running time of the script:** (1 minutes 27.549 seconds)
