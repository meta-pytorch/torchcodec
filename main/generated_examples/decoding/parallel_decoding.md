...
```
median = 5.67s ± 0.06
Speedup compared to sequential: 1.90x with 16 FFmpeg threads.
```
...
```
median = 4.36s ± 0.06
Speedup compared to sequential: 2.47x with 16 processes.
```
...
```
median = 1.44s ± 0.07
Speedup compared to sequential: 7.51x with 16 threads.
```
...
**Total running time of the script:** (1 minutes 33.549 seconds)
