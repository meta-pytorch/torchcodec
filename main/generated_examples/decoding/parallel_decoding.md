...
```
median = 4.40s ± 0.09
Speedup compared to sequential: 2.50x with 16 processes.
```
...
```
median = 1.44s ± 0.05
Speedup compared to sequential: 7.65x with 16 threads.
```
...
**Total running time of the script:** (1 minutes 34.645 seconds)
