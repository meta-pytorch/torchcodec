...
```
median = 3.71s ± 0.06
Speedup compared to sequential: 2.87x with 16 FFmpeg threads.
```
...
```
median = 1.45s ± 0.07
Speedup compared to sequential: 7.37x with 16 threads.
```
...
**Total running time of the script:** (1 minutes 25.564 seconds)
