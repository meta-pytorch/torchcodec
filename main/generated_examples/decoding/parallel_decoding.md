...
```
median = 5.70s ± 0.06
Speedup compared to sequential: 1.87x with 16 FFmpeg threads.
```
...
```
median = 1.44s ± 0.06
Speedup compared to sequential: 7.42x with 16 threads.
```
...
**Total running time of the script:** (1 minutes 33.425 seconds)
