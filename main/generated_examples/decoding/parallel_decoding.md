...
```
median = 4.36s ± 0.08
Speedup compared to sequential: 2.51x with 16 processes.
```
...
```
median = 1.42s ± 0.05
Speedup compared to sequential: 7.70x with 16 threads.
```
...
**Total running time of the script:** (1 minutes 26.727 seconds)
