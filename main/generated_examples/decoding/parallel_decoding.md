...
```
median = 5.65s ± 0.06
Speedup compared to sequential: 1.96x with 16 FFmpeg threads.
```
...
```
median = 4.35s ± 0.06
Speedup compared to sequential: 2.55x with 16 processes.
```
...
```
median = 1.43s ± 0.06
Speedup compared to sequential: 7.75x with 16 threads.
```
...
**Total running time of the script:** (1 minutes 35.002 seconds)
