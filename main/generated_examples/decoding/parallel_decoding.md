...
```
median = 5.70s ± 0.06
Speedup compared to sequential: 1.99x with 16 FFmpeg threads.
```
...
```
median = 1.47s ± 0.06
Speedup compared to sequential: 7.72x with 16 threads.
```
...
**Total running time of the script:** (1 minutes 36.514 seconds)
