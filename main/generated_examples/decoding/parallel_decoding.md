...
```
median = 5.68s ± 0.05
Speedup compared to sequential: 1.92x with 16 FFmpeg threads.
```
...
```
median = 1.43s ± 0.05
Speedup compared to sequential: 7.62x with 16 threads.
```
...
**Total running time of the script:** (1 minutes 34.760 seconds)
