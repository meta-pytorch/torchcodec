...
```
median = 3.70s ± 0.06
Speedup compared to sequential: 2.93x with 16 FFmpeg threads.
```
...
```
median = 1.42s ± 0.06
Speedup compared to sequential: 7.63x with 16 threads.
```
...
**Total running time of the script:** (1 minutes 26.192 seconds)
