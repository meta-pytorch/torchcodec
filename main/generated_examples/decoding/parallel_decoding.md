...
```
median = 4.35s ± 0.08
Speedup compared to sequential: 2.56x with 16 processes.
```
...
```
median = 1.42s ± 0.06
Speedup compared to sequential: 7.84x with 16 threads.
```
...
**Total running time of the script:** (1 minutes 35.292 seconds)
