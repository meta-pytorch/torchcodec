...
CompletedProcess(args=['ffmpeg', '-y', '-hide_banner', '-loglevel', 'error', '-f', 'lavfi', '-i', 'testsrc2=size=1280x720:rate=30:duration=5', '-c:v', 'libx264', '-pix_fmt', 'yuv420p', '-g', '30', '-colorspace', 'bt709', '-color_primaries', 'bt709', '-color_trc', 'bt709', '/tmp/tmpnqdr41t5/video.mp4'], returncode=0)
```
...
```
CompletedProcess(args=['ffmpeg', '-y', '-hide_banner', '-loglevel', 'error', '-i', '/tmp/tmpnqdr41t5/video.mp4', '-i', '/tmp/tmpnqdr41t5/audio.wav', '-c:v', 'copy', '-c:a', 'aac', '-shortest', '/tmp/tmpnqdr41t5/av.mp4'], returncode=0)
```
