...
[Blocks: build your own decoding pipeline](basics.html#sphx-glr-generated-examples-blocks-basics-py) ran the three stages -
[`Demuxer`](../../generated/torchcodec.decoders._blocks.Demuxer.html#torchcodec.decoders._blocks.Demuxer), [`VideoPacketDecoder`](../../generated/torchcodec.decoders._blocks.VideoPacketDecoder.html#torchcodec.decoders._blocks.VideoPacketDecoder), [`ColorConverter`](../../generated/torchcodec.decoders._blocks.ColorConverter.html#torchcodec.decoders._blocks.ColorConverter) - back
to back on the calling thread. That is the one pipeline shape
[`VideoDecoder`](../../generated/torchcodec.decoders.VideoDecoder.html#torchcodec.decoders.VideoDecoder) could have given you as well. This
...
Each stage is a generator: one over the [`Packet`](../../generated/torchcodec.decoders._blocks.Packet.html#torchcodec.decoders._blocks.Packet) objects a
[`Demuxer`](../../generated/torchcodec.decoders._blocks.Demuxer.html#torchcodec.decoders._blocks.Demuxer) produces, one over the [`RawFrame`](../../generated/torchcodec.decoders._blocks.RawFrame.html#torchcodec.decoders._blocks.RawFrame) objects a
...
One CUDA rule comes with this freedom. A [`RawFrame`](../../generated/torchcodec.decoders._blocks.RawFrame.html#torchcodec.decoders._blocks.RawFrame) is a view into a
...
[`RawFrame.record_stream()`](../../generated/torchcodec.decoders._blocks.RawFrame.html#torchcodec.decoders._blocks.RawFrame.record_stream) before the frame goes out of scope. A
[`ColorConverter`](../../generated/torchcodec.decoders._blocks.ColorConverter.html#torchcodec.decoders._blocks.ColorConverter) does it for you, so the pipelines above are safe;
see
[Raw frames and raw audio samples](raw_data.html#sphx-glr-generated-examples-blocks-raw-data-py) if you consume the
planes yourself.
...
[`VideoDecoder`](../../generated/torchcodec.decoders.VideoDecoder.html#torchcodec.decoders.VideoDecoder) can't do anything with that (we ask
