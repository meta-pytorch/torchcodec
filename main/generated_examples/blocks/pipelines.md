...
CompletedProcess(args=['ffmpeg', '-y', '-hide_banner', '-loglevel', 'error', '-f', 'lavfi', '-i', 'testsrc2=size=1280x720:rate=30:duration=5', '-c:v', 'libx264', '-pix_fmt', 'yuv420p', '-g', '30', '-colorspace', 'bt709', '-color_primaries', 'bt709', '-color_trc', 'bt709', '/tmp/tmp00s8segb/video.mp4'], returncode=0)
```
...
sequential : 0.48s (1.32x vs VideoDecoder)
...
**Total running time of the script:** (0 minutes 7.272 seconds)
