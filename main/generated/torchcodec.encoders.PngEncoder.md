...
`image.png`.
- **compression_level** ([*int*](https://docs.python.org/3/builtins/functions.html#int)*,**optional*) - zlib compression level between 0
...
to_tensor(***, *compression_level: [int](https://docs.python.org/3/builtins/functions.html#int) = 6*) → [Tensor](https://docs.pytorch.org/docs/stable/tensors.html#torch.Tensor)[[source]](../_modules/torchcodec/encoders/_image_encoders.html#PngEncoder.to_tensor)
