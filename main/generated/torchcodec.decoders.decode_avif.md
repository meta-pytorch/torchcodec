...
for higher-bit ones.
- **num_threads** ([*int*](https://docs.python.org/3/builtins/functions.html#int)*,**optional*) - Number of threads to use for decoding,
