...
useful, please let us know by [opening a feature request](https://github.com/pytorch/torchcodec/issues?q=is:open+is:issue).
...
Examples using `clips_at_regular_timestamps`:
